                  ...
                  <form action="{{ route('barangkeluar.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="kode_transaksi" value="{{ old('kode_transaksi') ? old('kode_transaksi') : $barangKeluar->kode_transaksi }}">
                        ...
                        <input type="text" class="form-control" name="kode_barang" value="{{ old('kode_barang') ? old('kode_barang') : $barangKeluar->kode_barang }}">
                        @error('kode_barang')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_barang" value="{{ old('nama_barang') ? old('nama_barang') : $barangKeluar->nama_barang }}">
                            @error('nama_barang')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>                      
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="jumlah" value="{{ old('jumlah') ? old('jumlah') : $barangKeluar->jumlah }}">
                            @error('jumlah')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="penerima" value="{{ old('penerima') ? old('penerima') : $barangKeluar->penerima }}">
                            @error('penerima')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    <!--end::Body-->
