                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="harga" value="{{ old('harga') }}" pattern="\d+" title="Masukkan hanya angka">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="lokasi_penyimpanan" value="{{ old('lokasi_penyimpanan') }}">
