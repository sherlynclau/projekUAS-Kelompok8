...
<html lang="en">
  ...
  <body class="sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      <!--begin::Header-->
      <nav class="app-header navbar navbar-expand" style="background-color: #dbe6ff;">
        <!--begin::Container-->
      ...
      <!--end::Header-->
      <!--begin::Sidebar-->
      <aside class="app-sidebar shadow" data-bs-theme="light" style="background-color: #dbe6ff;">
        <!--begin::Sidebar Brand-->
        <div class="sidebar-brand">
          ...
          <a class='brand-link' href='/dist/pages/'>
            ...
            {{-- <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Stock-ING</span> --}}
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
      ...
      <footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">Sistem Manajemen Stok Barang</div>
        <!--end::To the end-->
        <!--begin::Copyright-->
        <strong>
          Stock-ING &copy; 2025
